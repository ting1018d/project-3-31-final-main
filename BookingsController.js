...
//     }
    ...
    console.log(">>>session length : ", req.body.session_selected.length);
    //*    
    
    
    for (let q = 0; q < req.body.session_selected.length; q++) 
    ...
    Booking.findOne ({facility : req.body.facility_selected,    
        bookingDate : req.body.bookingDate, 
        session : req.body.session_selected[q]},function(err, result) {
            if (err) throw err;
            ...
            if (result !== null)
             {errors.push({text: "Session already booked"});
                ...
                bookingDate : req.body.bookingDate,
                session_selected : req.body.session_selected[q],  
                });
             }
            else
                {
                ...
                const newBooking = {
                    ...
                    bookingDate : req.body.bookingDate,
                    session : req.body.session_selected[q],
